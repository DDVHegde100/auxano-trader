# App Store Connect metadata (Auxano)

Copy into [App Store Connect](https://appstoreconnect.apple.com) → **Auxano** → **App Information** / **Version**.
...
| Email (auth) | Yes | No |
| User ID | Yes | No |
| Purchase history (paper) | Yes | No |
| Crash data | Optional | No |
...
| Field | Value |
|-------|--------|
| Support URL | `https://auxano-red.vercel.app` |
| Marketing URL | `https://auxano-red.vercel.app` |
